 ...
 * 
 *  
 * Originates from Secure Hash Algorithm (SHA256) http://www.webtoolkit.info/
 * Original code by Angel Marin, Paul Johnston.
 * 
 * 
 * SHA256 hash function with some convenience functions.
 * 
 */
(function (window) {
	 ...
	 * returns a hex representation of the hash
	 */
	this.hashBigInt = function (bigInteger) {
	 ...
	 * returns a hex representation of the hash
	 */
	this.hashInt = function (long) {

	    var bigint = leemon.int2bigInt(long, 1);
	    return this.hashBigInt(bigint);
	}
	...
	this.hashDate = function (date) {
	    ...
	    return this.hashString(dateFormatted);
	}
	 ...
	 * returns a hex representation of the hash
	 */
	this.hashHexStr = function (hexStr) {
	    /*
