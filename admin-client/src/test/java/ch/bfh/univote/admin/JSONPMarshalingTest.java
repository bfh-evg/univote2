...
public class JSONPMarshalingTest {
	...
	private static JsonObject unmarshal(String path) throws Exception {
		InputStream stream = new FileInputStream(path);
		JsonReader reader = Json.createReader(stream);
		return reader.readObject();
	}

	private static String marshal(JsonObject object) throws Exception {
	...
	private static JsonObject createVotingData(JsonObject electionDefinition, JsonObject electionDetails) {
