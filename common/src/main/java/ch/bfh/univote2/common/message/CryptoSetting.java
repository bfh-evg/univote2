 ...
 *		}
 *	},
 *	"required": ["encryptionSetting", "signatureSetting"],
 ...
 */
@XmlType(propOrder = {"encryptionSetting", "signatureSetting"})
public class CryptoSetting {
	...
	public CryptoSetting(String encryptionSetting, String signatureSetting) {
