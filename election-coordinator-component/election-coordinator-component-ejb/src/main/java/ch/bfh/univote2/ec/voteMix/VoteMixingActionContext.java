 ...
 */
public class VoteMixingActionContext extends ActionContext {

	private final List<String> mixerOrder;
	private final Map<String, PublicKey> mixerKeys;
	private List<EncryptedVote> currentVotes;
	...
	public List<EncryptedVote> getCurrentVotes() {
		return currentVotes;
	}

	public void setCurrentVotes(List<EncryptedVote> currentVotes) {
