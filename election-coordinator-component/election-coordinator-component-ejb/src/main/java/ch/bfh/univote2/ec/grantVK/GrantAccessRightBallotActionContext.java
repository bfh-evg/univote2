 ...
 */
public class GrantAccessRightBallotActionContext extends ActionContext {
	...
	public GrantAccessRightBallotActionContext(ActionContextKey actionContextKey, boolean runsInParallel) {
	...
	public void setMixedKeys(MixedKeys publicKeys) {
