...
\begin{itemize}
	\item Register$(i, e, Q ,\gamma): c$ \newline Where $Q$ represents the query for the messages the entity is interested in, $\gamma$ further arguments that limit the query and $c$ a return code, which can be used to unregister. 
