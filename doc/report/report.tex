...
\chapter{UniBoard}
%===============================================================================================
A bulletin board can have different properties. This section first presents some of the most important ones and then describes which have been selected for UniBoard.
\section{Properties}
...
TODO: give an identifier to content of the board
...
%\begin{itemize}
%	\item Post$(m,a_i)$ : -
%	\item Get$(a_i)$ : $\mathcal{R}_i$ where $(m,a_i) \in \mathcal{R}_i$
%\end{itemize}
...
In a structure board, a type identifier $T$ is added to the list of parameters $A$ when posting a message. For the query $Q$, $T$ is optional.
